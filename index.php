...
<body>
    ...
    <header class="header-area">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 d-md-flex">
                        <h6 class="mr-3"><span class="mr-2"><i class="fa fa-mobile"></i></span> call center 02-066-8888</h6>
        ...
        <div id="header" id="home">
            <div class="container">
                ...
                <div id="logo">
                    <a href="index.html"><img src="assets/img/logo.gif" width="120px" alt="" title="" /></a>
                </div>
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li class="menu-has-children"><a href="">Page</a>
                            <ul>
                                <li><a href="report/tel_in.php">เบอร์โทรภายใน</a></li>
                                <li><a href="elements.html">แจ้งซ่อม</a></li>
                            </ul>
                        </li>
    ...
    <section class="banner-area">
        <div class="container">
            <div class="row">
                <!-- <div class="col-lg-5">
                    <h1 style="color:#010F4B;">เจ้าหน้าที่เข้าสู่ระบบ</h1>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single-feature text-center item-padding">
                        ...
                        <h3>ตารางแพทย์</h3>
                        <p class="pt-3">วัน/เวลา ออกตรวจ-เลิกตรวจ<br>วัน/เวลา แพทย์งด</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-md-0">
                        <a onclick="window.open('assessment.php', '_blank', 'location=yes,height=770,width=1220,scrollbars=yes,status=yes');">
                        <img src="assets/images/feature2.png" alt="">
                        <h3>แบบประเมินความพึงพอใจ</h3>
                        <p class="pt-3">ประเมินความพึงพอใจการให้การบริการของโรงพยาบาล<br>ตอบแบบสอบถาม , แสดงความคิดเห็นของผู้ให้บริการ</p>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <section class="specialist-area section-padding">
        <div class="container">
            ...
            <?php 
                $sql = "select * from m_doctor";
                $query = mysql_query($sql);
                $i = 1;
                ?>
                <!-- //ตรงนี้จะเป็นแถว มีความยาว 12 col -->
    <div class='row'>  
            <?php while($res = mysql_fetch_array($query)){  
                // ตรงนี้มันจะแบ่ง เป็น คอลัม เอาตัวเลข มา /12 จะได้จำนวน คอลัม  [lg large screen    sm meduim screen    xs small screen]
                echo "<div class='col-lg-3 col-sm-6'>";   
                echo "<div class='single-doctor mb-4 mb-lg-0'>";
                echo "<a onclick='window.open('doctors.php','_blank','location=yes,height=770,width=1220,scrollbars=yes,status=yes');'><div class='doctor-img'><img src='fileupload/".$res['DOCTOR_IMG_NAME']."' alt='error' width='150px'></div></a>";
                echo "<div class='content-area'>";
                echo "<div class='doctor-name text-center'>";
                echo "ethel davis<br>";
                echo "sr. faculty data science";
                echo "</div>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            ...
            <!-- <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-lg-0">
                        <a onclick="window.open('doctors.php', '_blank', 'location=yes,height=770,width=1220,scrollbars=yes,status=yes');"><div class="doctor-img">
                        <img src="fileupload/<?php echo $res["DOCTOR_IMG_NAME"];?>" width="120px"  alt="" class="img-fluid">
                        </div>
